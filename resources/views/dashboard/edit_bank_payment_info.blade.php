                ...
                <div class="col-lg-12">
                    <div class="white_card card_height_100 mb_30">
                        ...
                        <div class="white_card_body">
                            <div class="card-body">
                                <form action="{{ url('/') }}/dashboard/update-bank-payment-info/{{ $data->bank_id }}"
                                    method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <label class="form-label" for="inputEmail4">Bank Name</label>
                                            <input type="text" class="form-control" id="inputEmail4" name="bank_name"
                                        ...
                                        <div class=" col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="inputPassword4"
                                                name="account_title" value="{{ $data->account_title }}"
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <label class="form-label" for="inputState">Upload Bank Logo</label>
                                            <input type="file" name="bankimage" class="form-control" >
                                            <br>
                                            <img src="{{url('/public/myimages')}}/{{$data->bank_img}}" width="100" height="100" alt="">
                                            <input type="hidden" name="oldimg" value="{{$data->bank_img}}" >
                                        </div>
                                    </div>
