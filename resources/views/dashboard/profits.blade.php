...
@section('content')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            const route = "{{ route('profits') }}"; // Set the AJAX route
                    ...
                    success: function(data) {
                        ...
                        data.data.forEach(user => {
                            ...
                            if (userRole === 3 || userRole === 4) {
                                rowHtml += `
                                <td><a href="#" class="question_content">${user.profite_id}</a></td>
                            ...
                            if (user.tstatus === 0) {
                                rowHtml +=
                                    '<td><a href="#" class="status_btn bg-warning">Panding</a></td>';
                            }
                            if (user.tstatus === 1) {
                                rowHtml +=
